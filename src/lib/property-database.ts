  ...
  async upsertProperties(properties: CleanedProperty[]): Promise<{
    ...
    const transaction = this.db.transaction((properties: CleanedProperty[]) => {
      for (const property of properties) {
        try {
          const exists = checkExistingStmt.get(property.ListingKey);
          
          insertStmt.run(
            property.ListingKey,
            property.ListPrice || null,
            property.UnparsedAddress || null,
            property.cleanedAddress || null,
            ...
            property.ListingContractDate || null,
            ...
            property.PrivateRemarks || null,
            property.ListAgentFullName || null,
            property.ListOfficeName || null,
            property.ParkingTotal || null,
            property.GarageSpaces || null,
            property.FireplacesTotal || null,
            property.PoolPrivateYN ? 1 : 0,
            property.WaterfrontYN ? 1 : 0,
            property.ViewYN ? 1 : 0,
            property.CoolingYN ? 1 : 0,
            property.HeatingYN ? 1 : 0,
            property.InternetYN ? 1 : 0,
            property.SpaYN ? 1 : 0,
            property.DaysOnMarket || null,
            property.OriginalListPrice || null,
            property.PriceChangeTimestamp || null,
            property.CloseDate || null,
            property.ClosePrice || null,
            property.CumulativeDaysOnMarket || null,
            property.AssociationFee || null,
            property.TaxAnnualAmount || null,
            property.WalkScore || null,
            property.SchoolDistrictName || null,
            property.ElementarySchoolName || null,
            property.MiddleOrJuniorSchoolName || null,
            property.HighSchoolName || null,
            property.pricePerSqFt || null,
            property.isLuxury ? 1 : 0,
            property.searchKeywords ? JSON.stringify(property.searchKeywords) : null
          );
