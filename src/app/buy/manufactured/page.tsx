...
function ManufacturedPageContent() {
  ...
  const handleFilterChange = (newFilters: PropertyFilters) => {
    ...
    const newUrl = `/buy/manufactured${params.toString() ? '?' + params.toString() : ''}`
  ...
  return (
    <main className="bg-slate-50 dark:bg-slate-900 min-h-screen pt-16 md:pt-20 theme-transition">
      <PropertyListingHeader 
        ...
        propertyType="Manufactured Homes for Sale"
              ...
              {properties.length > 0 ? (
                ...
                <div className="text-center py-12">
                  <div className="text-gray-500 text-lg mb-4">
                    🏡 No manufactured homes found with current filters
                  </div>
