...
function TownhousesPageContent() {
  ...
  const handleFilterChange = (newFilters: PropertyFilters) => {
    ...
    const newUrl = `/buy/townhouses${params.toString() ? '?' + params.toString() : ''}`
              ...
              {properties.length > 0 ? (
                ...
                <div className="text-center py-12">
                  <div className="text-gray-500 text-lg mb-4">
                    🏘️ No townhouses found with current filters
                  </div>
