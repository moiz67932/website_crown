            ...
            <Card className="overflow-hidden h-full hover:shadow-md transition-all group">
              <div className="relative">
                <div className="relative h-48 sm:h-56 md:h-64">
                  <img src={"http://34.133.70.161:8000/proxy-image?url=" + property.main_image_url} alt={property.title} className="object-cover w-full h-full transition-transform duration-500 group-hover:scale-105"
                  />
