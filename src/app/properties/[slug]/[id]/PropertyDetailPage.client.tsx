...
import {
  PropertyDetail,
  usePropertyDetail,
} from "@/hooks/queries/useGetDetailProperty";
...
const generatePropertyJsonLd = (property: PropertyDetail | undefined) => {
  ...
  return {
    ...
    url: `${siteUrl}/properties/${property?.address?.replace(/ /g, "-")}/${
    ...
    <>
      ...
      <div className="bg-neutral-50 dark:bg-slate-900 min-h-screen w-full pt-16 theme-transition">
        ...
        <section className="relative overflow-hidden">
          ...
          {/* Overlay title / price panel - Mobile: Below image, Desktop: Overlay */}
          <div className="relative sm:absolute bottom-0 left-0 right-0 z-20 p-4 sm:p-6 lg:p-8">
            <div className="container mx-auto">
              <div className="bg-white dark:bg-slate-900 sm:bg-white/10 sm:dark:bg-slate-900/20 backdrop-blur-2xl border border-neutral-200 dark:border-slate-700 sm:border-white/20 sm:dark:border-slate-700/30 rounded-3xl p-4 sm:p-6 lg:p-8 shadow-2xl animate-fade-in-up">
                <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 sm:gap-6">
                  <div className="flex-1">
                    {(() => {
                      ...
                      if (
                        ...
                        displayName = "";
                      return displayName ? (
                        <h1 className="text-xl md:text-2xl lg:text-3xl font-display font-semibold text-neutral-900 dark:text-neutral-100 sm:text-white mb-2 tracking-tight drop-shadow-md">
                          {displayName}
                        </h1>
                      ) : null;
                    })()}
                    <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                      <Badge
                        className={`px-3 sm:px-4 py-1.5 sm:py-2 rounded-2xl font-bold text-white border-none shadow-lg text-xs sm:text-sm ${
                      ...
                      <span className="text-neutral-700 dark:text-neutral-300 sm:text-white/80 text-xs sm:text-sm font-medium">
                        {propertyData.days_on_market ?? "—"} days on market
                      </span>
                    </div>
                    <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-display font-bold text-neutral-900 dark:text-neutral-100 sm:text-white mb-2 sm:mb-3 leading-tight">
                      {(propertyData.address || "")
                        .replace(/^0+\s+/, "")
                        .trim()}
                    </h1>
                    <div className="flex items-center text-neutral-700 dark:text-neutral-300 sm:text-white/90 text-sm sm:text-base lg:text-lg">
                  ...
                  <div className="flex-shrink-0">
                    <div className="text-right">
                      <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-display font-bold text-neutral-900 dark:text-neutral-100 sm:text-white mb-2">
                        ${propertyData.list_price?.toLocaleString()}
                      </div>
                      <div className="text-neutral-700 dark:text-neutral-300 sm:text-white/80 text-xs sm:text-sm">
                        {propertyData.property_type === "ResidentialLease"
                          ? "per month"
                          : "listing price"}
                      </div>
                ...
                <div className="prose prose-lg dark:prose-invert max-w-none">
                  <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed whitespace-pre-line">
                    {propertyData.public_remarks ||
                      "This beautiful property offers modern living with exceptional features and prime location."}
                  </p>
                </div>
                ...
                <div className="glass-card p-8 rounded-3xl animate-scale-in">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-gradient-to-br from-success-50 to-success-100 dark:from-success-900/20 dark:to-accent-800/20 rounded-2xl p-6 text-center hover-lift">
                      ...
                      <p className="text-neutral-700 dark:text-neutral-300 text-sm">
                        {propertyData.other_info?.RecreationFeatures ||
                          "Recreation info not available"}
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
                      <Button
                        ...
                        onClick={() =>
                          window.open(
                            `https://www.google.com/maps?q=${propertyData.latitude},${propertyData.longitude}`,
                            "_blank"
                          )
                        }
                        className="w-full sm:flex-1 border-neutral-200 dark:border-slate-600 hover:bg-primary-50 dark:hover:bg-primary-900/30"
                      >
                      ...
                      <Button
                        ...
                        onClick={() =>
                          window.open(
                            `http://maps.apple.com/?q=${propertyData.latitude},${propertyData.longitude}`,
                            "_blank"
                          )
                        }
                        className="w-full sm:flex-1 border-neutral-200 dark:border-slate-600 hover:bg-accent-50 dark:hover:bg-accent-900/30"
                      >
                        <MapPin className="h-4 w-4 mr-2" />
                        Open in Apple Maps
                      </Button>
                  ...
                  <div className="h-96 bg-gradient-to-br from-neutral-100 to-neutral-200 dark:from-slate-800 dark:to-slate-700 rounded-2xl flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-neutral-500 dark:text-neutral-500 text-sm mt-2">
                        Coordinates: {propertyData.latitude || "N/A"},{" "}
                        {propertyData.longitude || "N/A"}
                      </p>
                    </div>
                  </div>
                )}
            ...
            <div>
              <div className="space-y-6 lg:sticky lg:top-24">
                <div className="glass-card p-8 rounded-3xl">
                  ...
                  <ContactForm
                    propertyId={propertyData.listing_key}
                    proertyData={propertyData}
                  />
                </div>
              </div>
            </div>
