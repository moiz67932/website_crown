...
import nextDynamic from "next/dynamic" // alias to avoid any conflict with route-segment 'dynamic'
...
export default function PropertyDetailClient({ params }: ClientProps) {
