...
export default async function Page({
  ...
  return <PropertyDetailClient params={resolved} searchParams={resolvedSearch} />
}
/*
// "use client"
...
// export default async function Page({
//   params,
// Server wrapper for property detail page
// Ensures compatibility with Next.js PageProps (params provided as a Promise in type layer)
import PropertyDetailClient from "./page.client"
...
export default async function Page({
  ...
  const resolved = await params
  if (!resolved?.id) return null
  return <PropertyDetailClient params={resolved} searchParams={searchParams} />
}
                    </div>
...
// import nextDynamic from "next/dynamic" // <-- aliased to avoid conflict with route-segment 'dynamic'
