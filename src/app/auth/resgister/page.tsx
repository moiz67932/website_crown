    ...
    <div className="min-h-screen flex flex-col md:flex-row pt-16">
      ...
      <div className="hidden md:block w-1/2 bg-slate-100 relative">
        <div className="absolute inset-0">
          <Image src="/modern-beach-house.png" alt="Luxury Real Estate" fill className="object-cover" priority />
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-4 md:p-8 lg:p-12">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl md:text-3xl font-bold mt-6 text-slate-900">Create an Account</h1>
            <p className="text-slate-600 mt-2">Sign up to start your real estate journey</p>
          </div>
